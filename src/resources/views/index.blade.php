...
<div class="todo__content">
    <form action="/" class="create-form">
        <div class="create-form__item">
            <input type="text" name="content" id="" class="create-form__item-input">
        </div>
        <div class="create-form__button">
            <input type="button" value="作成" class="create-form__button-submit">
        </div>
    </form>
                ...
                <td class="todo-table__item">
                    <form action="" class="update-form">
                        <div class="update-form__item">
                            <input type="text" name="content" value="text1" class="update-form__item-input">
                        </div>
